...
map += `
    ...
    <a href="https://${webx}/mp3/${entry}">${entry}</a>
    <div class="top-music">
                        <div class="tm-cover"><a href="/mp3/${entry}"
                                title="${entry}"><img
                                    data-src="/favicons/mstile-150x150.png"
                                    class="lazy" alt="${entry}" title="${entry}"></a></div>
                        <div class="tm-info"><a class="tm-title" href="/mp3/${entry}"
                                title="${entry}</a>
                            <ul class="tm-details">
                                <li><span class="fas fa-user-crown"></span><a href="/mp3/${entry}"
                                        title="Nocap MP3 Download 320kbps"></a></li>
                                <li><span class="far fa-calendar-sta"></span></li>
                            </ul>
                        </div>
                    </div>
...
<head>
    <title> Music Sitemap</title>
    <meta property="og:title" content=" Music Sitemap" />
    <meta name="description"
        content="Music Sitemap" />
    <meta property="og:description"
        content="Music Sitemap" />
    <meta name="keywords"
        content="Song Uber, Music Sitemap, mp3 download, music download, song download, 320kbps mp3, 320kbps music, mp3 music, free mp3, free music, " />
...
<body>
    <div class="leading">
        ...
        <div class="header">
            <div class="layout"><a class="logo" href="/"
                ...
                <div class="search"><input type="text" id="searchInput" value="Music Sitemap"
            ...
            <div class="layout">
                <div class="music-cover">
                    <div class="music-image mcover">
                        <div data-image="" data-title="Music Sitemap"></div>
                    </div>
                </div>
                <div class="music-details" data-media="">
                    <div class="mdetails-info">
                        <h1> <span class="mp3-dl">MP3 Free Download</span></h1>
                        <ul class="music-info">
                            ...
                            <li><span class="fas fa-play"></span></li>
    ...
    <div class="showcase">
        <div class="layout">
            <div class="results">  
                <!-- <h2>Music Sitemap MP3 Music Songs</h2> -->
